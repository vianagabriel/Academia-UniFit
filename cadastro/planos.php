...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-item nav-link" href="aulas.php">Aulas</a>
    ...
    <main>
        <div class="mb-3">
            <button class="btn btn-primary" id="btnAddPlano" onclick="abrirModalCadastro()"><i class="fas fa-plus"></i> Adicionar Planos</button>
        </div>
        <div class="card">
                ...
                <div class="modal-body">
                    <form action="planos.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="valor" class="form-control" name="valor" placeholder="Digite o Valor" required>
                        </div>
                        <div class="form-group">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <h5>Tem certeza que quer inativar esse plano?</h5>
                    <form action="planos.php" method="post">
                        <!-- IMPORTANTE MANTER O class="idCadastro"-->
    ...
    <div id="modalAtivar" class="modal modal-lg" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Inativar Planos</h5>
                </div>
                <div class="modal-body text-center">
                    <h5>Tem certeza que quer ativar esse plano?</h5>
                    <form action="planos.php" method="post">
                        <!-- IMPORTANTE MANTER O class="idCadastro"-->
